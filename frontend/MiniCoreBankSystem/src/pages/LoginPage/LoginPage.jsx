  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-100 via-purple-100 to-pink-100 flex items-center justify-center p-4">
      <div className="flex flex-col md:flex-row w-full max-w-5xl rounded-2xl shadow-2xl overflow-hidden">
        {/* Left Side - Bank Image (no background) */}
        <div className="hidden md:block md:w-1/2">
          <img
            src="/src/assets/generated.png"
            alt="Bank building"
        ...
        <div className="w-full md:w-1/2 bg-white p-8">
          <div className="bg-gradient-to-r from-indigo-600 to-purple-600 p-6 text-center rounded-tl-2xl rounded-tr-2xl md:rounded-tr-none md:rounded-bl-2xl">
                  ...
                  {showPassword ? (
                    ...
                    >
                      <path
                        strokeLinecap="round"
                        strokeLinejoin="round"
                        d="M3 3l18 18M9.88 9.88A3 3 0 0112 9c1.657 0 3 1.343 3 3 0 .512-.13.995-.36 1.41M6.1 6.1A9.956 9.956 0 002 12c0 5.523 4.477 10 10 10 1.657 0 3.234-.336 4.675-.938"
                      />
                    </svg>
                  )}
                </button>
