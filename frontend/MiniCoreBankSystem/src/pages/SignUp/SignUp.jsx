...
const SignUp = () => {
  ...
  const securityQuestions = [
    { value: "MOTHERS_MIDDLE_NAME", label: "What is your mother's middle name?" },
    { value: "FIRST_PET_NAME", label: "What is the name of your first pet?" },
    { value: "FIRST_HIGHSCHOOL_NAME", label: "Where did you attend your first high school?" },
    { value: "CITY_YOU_GREW_UP", label: "Where is the city where you grew up?" },
    { value: "CHILDHOOD_BOOK_NAME", label: "What is your favourite childhood book title?" }
  ];
      ...
      <div className="bg-white rounded-xl shadow-lg overflow-hidden flex flex-col md:flex-row w-full max-w-4xl">
        ...
        <div className="md:w-3/5 p-8 md:p-10">
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label htmlFor="hashPassword" className="block text-sm font-medium text-gray-700 mb-1">Password</label>
                <input 
                  type="password" 
                  id="hashPassword" 
                  required
            ...
            <div>
              <label htmlFor="questionLists" className="block text-sm font-medium text-gray-700 mb-1">Security Question</label>
              <select
                name="questionLists"
                required
            ...
            <div>
              <label htmlFor="userAnswer" className="block text-sm font-medium text-gray-700 mb-1">Answer</label>
              <input 
                type="text" 
                id="userAnswer" 
                required
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3 text-sm">
                <label htmlFor="terms" className="font-medium text-gray-700">
                  I agree to the{' '}
                  <a href="/api/terms" className="text-indigo-600 hover:text-indigo-800">
            ...
            <button 
              ...
              className={`w-full mt-6 bg-indigo-600 text-white py-3 px-4 rounded-lg font-medium hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition ${(!agreeToTerms || isSubmitting) ? 'opacity-70 cursor-not-allowed' : ''}`}
            >
              {isSubmitting ? (
